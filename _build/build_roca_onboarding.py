  ...
  <div class="form-section">
    <div class="fld-row">
      <div class="fld">
        ...
        <input type="text" id="legal_name" name="legal_name" required placeholder="e.g. Roca Fuel Trading Co. W.L.L.">
...
<section id="project" class="page" aria-labelledby="project-title">
  ...
  <div class="form-section">
    ...
    <div class="fld-row">
      <div class="fld">
        <label for="customer_base_size">Approx. Total Products <span class="req">*</span></label>
        <input type="number" id="customer_base_size" name="customer_base_size" required value="500" min="1" placeholder="500">
    ...
    <div class="fld">
      ...
      <div class="fld-row">
        <div class="fld">
          ...
          <input type="text" id="email_1" name="email_1" required value="info@rocafuel.com">
        </div>
        <div class="fld">
          <label for="email_2" style="font-size:10px;color:var(--muted)">Address 2</label>
          <input type="text" id="email_2" name="email_2" required value="sales@rocafuel.com">
        </div>
      </div>
      <div class="fld">
        <label for="email_3" style="font-size:10px;color:var(--muted)">Address 3</label>
        <input type="text" id="email_3" name="email_3" required value="support@rocafuel.com">
      </div>
