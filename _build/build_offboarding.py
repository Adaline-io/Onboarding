#!/usr/bin/env python3
"""
Adaline — Project OFFBOARDING Form  (STARTER)
Same brand system as the onboarding forms (dark theme, Space Grotesk /
Inter / JetBrains Mono). Posts to the SAME Apps Script webhook with
_meta.form = "offboarding", so submissions land in the "Offboarding" tab
of the Adaline Onboarding sheet automatically.

HOW TO USE: replace the ⟨Client⟩ / ⟨Project⟩ placeholders and edit the
four sections (Your Details / Closeout / Handover / Before You Go) to
match the client's offboarding scope, then run this script to build
../offboarding/index.html. No payment block (offboarding has none).
"""
import base64
import pathlib
...
(function(){
  ...
  function gatherFormData() {
    const data = { _meta: { client: '⟨Client⟩', project: '⟨Project⟩', form: 'offboarding', submitted_at: new Date().toISOString(), project_total: '' } };
    const sections = ['client', 'closeout', 'handover', 'feedback'];
  ...
  function formatForWhatsApp(data) {
    let lines = [`*⟨Client⟩ — Project Offboarding Submission*`, ''];
    lines.push(`Submitted: ${new Date().toLocaleString()}`);
    lines.push(`Form: Offboarding`);
    lines.push('');
    const labels = { client: '01 · Your Details', closeout: '02 · Closeout', handover: '03 · Handover', feedback: '04 · Before You Go' };
...
<section class="hero page" id="cover" aria-label="Cover">
  <div class="hero-head">
    <div class="tag">Project Offboarding</div>
    <div class="meta">
      <div><span class="ml">Client</span> <span class="mv">⟨Client⟩</span></div>
      <div><span class="ml">Engagement</span> <span class="mv">⟨Project⟩</span></div>
    </div>
  </div>
  <div class="hero-mid">
    <div>
      <div class="label">Wrapping up</div>
      <h1>Let's close<br/>this out<span class="ac">.</span></h1>
      <div class="sub">
        <span>~5 minutes</span><span class="dot"></span>
        <span>4 sections</span><span class="dot"></span>
  ...
  <div class="hero-foot">
    <div class="desc">A short offboarding form to confirm the work is complete, hand over your assets and access, and wrap up cleanly. Fill it in and hit submit — your project lead takes it from there.</div>
    <div class="byline">Offboarding by<br/><strong>Adaline · The Agency</strong></div>
  </div>
</section>
"""
...
<section id="process" class="page" aria-labelledby="process-title">
  ...
  <h2 class="sec-title" id="process-title">A clean handover, start to finish.</h2>
  <p class="sec-sub">Once this form is submitted, your project lead confirms everything received, transfers your assets and access, and closes out any final invoice.</p>

  <div class="proc-strip">
    <div class="proc-step now"><div class="pn">STEP 01</div><h4>You Submit</h4><p>This form. ~5 minutes.</p></div>
    <div class="proc-step"><div class="pn">STEP 02</div><h4>Confirm</h4><p>We check off every deliverable and flag anything outstanding.</p></div>
    <div class="proc-step"><div class="pn">STEP 03</div><h4>Handover</h4><p>Domain, hosting, files and accounts transferred to you; Adaline access removed.</p></div>
    <div class="proc-step"><div class="pn">STEP 04</div><h4>Close</h4><p>Final invoice settled, records archived. Door stays open for future work.</p></div>
  </div>
</section>
"""

COMPANY = """
<section id="client" class="page" aria-labelledby="client-title">
  <div class="kicker">01 · Your Details</div>
  <h2 class="sec-title" id="client-title">Who's signing off.</h2>
  <p class="sec-sub">The person confirming this offboarding on the client's side.</p>

  <div class="form-section">
    <div class="fld">
      <label for="legal_name">Legal Entity Name <span class="req">*</span></label>
      <input type="text" id="legal_name" name="legal_name" required placeholder="e.g. ⟨Client⟩ LLP">
      <div class="err-msg">Required</div>
    </div>
    <div class="fld-row">
      <div class="fld">
        <label for="signoff_name">Your Name <span class="req">*</span></label>
        <input type="text" id="signoff_name" name="signoff_name" required>
        <div class="err-msg">Required</div>
      </div>
      <div class="fld">
        <label for="signoff_role">Role <span class="req">*</span></label>
        <input type="text" id="signoff_role" name="signoff_role" required placeholder="e.g. Managing Director">
        <div class="err-msg">Required</div>
      </div>
    </div>
    <div class="fld">
      <label for="signoff_email">Email <span class="req">*</span></label>
      <input type="email" id="signoff_email" name="signoff_email" required placeholder="name@client.com">
...
PROJECT = """
<section id="closeout" class="page" aria-labelledby="closeout-title">
  <div class="kicker">02 · Closeout</div>
  <h2 class="sec-title" id="closeout-title">Confirm the work is complete.</h2>
  <p class="sec-sub">Tell us where things stand so nothing slips through.</p>

  <div class="form-section">
    <div class="fld">
      <label>Deliverables <span class="req">*</span></label>
      <div class="opt-cards">
        <label class="opt-card"><input type="radio" name="deliverables" value="all_received" required><span class="dot"></span><div class="ct"><div class="h">All received</div><div class="d">Everything delivered and approved</div></div></label>
        <label class="opt-card"><input type="radio" name="deliverables" value="mostly"><span class="dot"></span><div class="ct"><div class="h">Mostly</div><div class="d">A few items still open — noted below</div></div></label>
        <label class="opt-card"><input type="radio" name="deliverables" value="outstanding"><span class="dot"></span><div class="ct"><div class="h">Outstanding</div><div class="d">Significant items pending</div></div></label>
      </div>
      <div class="err-msg">Pick one</div>
    </div>
    <div class="fld">
      <label for="outstanding_notes">Outstanding items (optional)</label>
      <textarea id="outstanding_notes" name="outstanding_notes" placeholder="Anything still pending or to flag before we close"></textarea>
    </div>
    <div class="fld">
      <label class="opt"><input type="checkbox" name="final_signoff" value="confirmed" required><span class="dot"></span>I confirm the engagement is complete and approved</label>
    </div>
  </div>
</section>
"""
...
ACCESS = """
<section id="handover" class="page" aria-labelledby="handover-title">
  <div class="kicker">03 · Handover</div>
  <h2 class="sec-title" id="handover-title">Assets and access — where they go.</h2>
  <p class="sec-sub">What we hand back, and who holds it after.</p>

  <div class="form-section">
    <div class="fld">
      <label>What to hand over</label>
      <div class="opt-group">
        <label class="opt"><input type="checkbox" name="handover_items" value="domain"><span class="dot"></span>Domain</label>
        <label class="opt"><input type="checkbox" name="handover_items" value="hosting"><span class="dot"></span>Hosting</label>
        <label class="opt"><input type="checkbox" name="handover_items" value="website_files"><span class="dot"></span>Website files</label>
        <label class="opt"><input type="checkbox" name="handover_items" value="design_files"><span class="dot"></span>Design files</label>
        <label class="opt"><input type="checkbox" name="handover_items" value="social_accounts"><span class="dot"></span>Social accounts</label>
        <label class="opt"><input type="checkbox" name="handover_items" value="analytics"><span class="dot"></span>Analytics</label>
      </div>
    </div>
    <div class="fld">
      <label for="transfer_to_email">Transfer ownership to <span class="req">*</span></label>
      <input type="email" id="transfer_to_email" name="transfer_to_email" required placeholder="Email that should own the accounts">
      <div class="err-msg">Valid email required</div>
    </div>
    <div class="fld">
      <label>Adaline access</label>
      <div class="opt-group">
        <label class="opt"><input type="radio" name="access_revoke" value="revoke_now"><span class="dot"></span>Revoke now</label>
        <label class="opt"><input type="radio" name="access_revoke" value="after_transfer"><span class="dot"></span>Keep until transfer confirmed</label>
      </div>
    </div>
  </div>
</section>
...
COMMS = """
<section id="feedback" class="page" aria-labelledby="feedback-title">
  <div class="kicker">04 · Before You Go</div>
  <h2 class="sec-title" id="feedback-title">Before you go.</h2>
  <p class="sec-sub">Optional — but it helps us get better.</p>

  <div class="form-section">
    <div class="fld">
      <label>How was working with us?</label>
      <div class="opt-cards">
        <label class="opt-card"><input type="radio" name="satisfaction" value="great"><span class="dot"></span><div class="ct"><div class="h">Great</div><div class="d">Would recommend</div></div></label>
        <label class="opt-card"><input type="radio" name="satisfaction" value="good"><span class="dot"></span><div class="ct"><div class="h">Good</div><div class="d">Solid, a few notes</div></div></label>
        <label class="opt-card"><input type="radio" name="satisfaction" value="mixed"><span class="dot"></span><div class="ct"><div class="h">Mixed</div><div class="d">Room to improve</div></div></label>
      </div>
    </div>
    <div class="fld">
      <label for="testimonial">A line we can quote (optional)</label>
      <textarea id="testimonial" name="testimonial" placeholder="Happy to share a short testimonial? Drop it here"></textarea>
    </div>
    <div class="fld">
      <label>Future work?</label>
      <div class="opt-group">
        <label class="opt"><input type="radio" name="future_work" value="yes"><span class="dot"></span>Yes, keen</label>
        <label class="opt"><input type="radio" name="future_work" value="maybe"><span class="dot"></span>Maybe later</label>
        <label class="opt"><input type="radio" name="future_work" value="no"><span class="dot"></span>Not now</label>
      </div>
    </div>
  </div>
</section>
...
<section id="submit" class="page" aria-labelledby="submit-title">
  ...
  <div class="submit-box">
    <h3>Submit &amp; close out the project</h3>
    <p>Your project lead will confirm receipt and complete the handover.</p>
    <button type="button" class="submit-btn" id="submit-btn">Submit &amp; Close Out <span class="arr"></span></button>
...
<section class="page success-wrap" aria-label="Submission success">
  <div class="success-state" id="success-state" role="status" aria-live="polite">
    <div class="check"></div>
    <h3>All wrapped up. Thank you.</h3>
    <p>Submission received. Your project lead will confirm the handover and close things out shortly.</p>
    <div class="next-steps">
      <strong>NEXT STEPS</strong><br/>
      → Your project lead confirms everything received<br/>
      → Assets and access are transferred to you<br/>
      → Any final invoice is settled<br/>
      → Records archived — the door stays open for future work<br/>
    </div>
  </div>
</section>
"""
...
<aside class="mobile-menu" aria-label="Mobile navigation">
  ...
  <a href="#client"><span>Your Details</span><span class="mm-num">01</span></a>
  <a href="#closeout"><span>Closeout</span><span class="mm-num">02</span></a>
  <a href="#handover"><span>Handover</span><span class="mm-num">03</span></a>
  <a href="#feedback"><span>Before You Go</span><span class="mm-num">04</span></a>
  <a href="#submit"><span>Submit</span><span class="mm-num">05</span></a>
</aside>
"""
...
<title>Project Offboarding · ⟨Client⟩</title>
<meta name="description" content="Project Offboarding for ⟨Client⟩ — Adaline The Agency.">
...
<nav class="topnav" aria-label="Primary">
  <div class="ntag">
    <span class="ntag-main">⟨Client⟩</span>
    <span class="sep">/</span>
    <span class="small">Project Offboarding</span>
  </div>
  <div class="nlinks">
    <a href="#client">You</a>
...
OUT = pathlib.Path(__file__).parent.parent / 'offboarding' / 'index.html'
