#!/usr/bin/env python3
"""
BZ Fitness — Project Onboarding Form
...
:root{
  ...
  --acc:#ff4d2e;--acc-2:#ff8a3d;--acc-soft:#cc3920;
...
body{margin:0;background:radial-gradient(ellipse 80% 50% at 50% 0%,rgba(255,77,46,.045),transparent 60%),var(--paper);color:var(--ink);font-family:var(--body);font-size:15.5px;line-height:1.65;-webkit-font-smoothing:antialiased;min-height:100vh;overflow-x:hidden}
...
.submit-btn:hover:not(:disabled){transform:translateY(-1px);box-shadow:0 6px 24px rgba(255,77,46,.3)}
...
(function(){
  ...
  function formatForWhatsApp(data) {
    let lines = [`*BZ Fitness — Project Onboarding Submission*`, ''];
    lines.push(`Submitted: ${new Date().toLocaleString()}`);
    lines.push(`Project Total: ₹93,000`);
    lines.push('');
...
<section class="hero page" id="cover" aria-label="Cover">
  <div class="hero-head">
    ...
    <div class="meta">
      <div><span class="ml">Project</span> <span class="mv">BZ Fitness Website Rebuild</span></div>
      <div><span class="ml">Programme</span> <span class="mv">₹93,000 · 25–30 days</span></div>
    </div>
  </div>
  <div class="hero-mid">
    <div>
  ...
  <div class="hero-foot">
    <div class="desc">A short onboarding form to give Adaline everything we need to start work on the BZ Fitness website rebuild. Fill it in, hit submit, and kickoff happens within 48 hours. Sticky bar at the bottom tracks your progress.</div>
...
<section id="process" class="page" aria-labelledby="process-title">
  ...
  <div class="proc-strip">
    ...
    <div class="proc-step"><div class="pn">STEP 04</div><h4>Launch</h4><p>Week 6. Testing, hosting, webmail go-live, training session, handover. Site live at bzfitness.com.</p></div>
  </div>
</section>
"""
  ...
  <div class="form-section">
    <div class="fld-row">
      ...
      <div class="fld">
        ...
        <input type="text" id="trade_name" name="trade_name" placeholder="e.g. BZ Fitness">
      </div>
    </div>
  ...
  <div class="form-section">
    ...
    <div class="fld-row">
      <div class="fld">
        ...
        <input type="email" id="dm_email" name="dm_email" required placeholder="name@bzfitness.com">
...
<section id="project" class="page" aria-labelledby="project-title">
  ...
  <h2 class="sec-title" id="project-title">Brand, products, photography. What's ready, what's not.</h2>
  ...
  <div class="form-section">
    ...
    <div class="fld-row">
      <div class="fld">
        <label for="product_count">Approx. Total Products <span class="req">*</span></label>
        <input type="number" id="product_count" name="product_count" required value="500" min="1" placeholder="500">
        <div class="hint">Roughly. We'll structure the catalog around this number.</div>
        <div class="err-msg">Required</div>
      </div>
      <div class="fld">
        <label for="categories_count">Approx. Categories</label>
        <input type="number" id="categories_count" name="categories_count" value="5" min="1" placeholder="5">
        <div class="hint">Cardio, Strength (sub-types), Accessories, etc.</div>
      </div>
    </div>

    <div class="fld">
      <label>Product Data Ready? <span class="req">*</span></label>
      <div class="hint" style="margin-bottom:10px">Spec sheets, dimensions, weights, descriptions for each product</div>
      <div class="opt-cards">
        <label class="opt-card"><input type="radio" name="product_data" value="ready" required><span class="dot"></span><div class="ct"><div class="h">Ready</div><div class="d">All in a spreadsheet, ready to share</div></div></label>
        <label class="opt-card"><input type="radio" name="product_data" value="partial"><span class="dot"></span><div class="ct"><div class="h">Partial</div><div class="d">Some categories ready, others need work</div></div></label>
        <label class="opt-card"><input type="radio" name="product_data" value="need_template"><span class="dot"></span><div class="ct"><div class="h">Need template</div><div class="d">Send us a spreadsheet to fill in</div></div></label>
      </div>
      <div class="err-msg">Pick one</div>
    </div>

    <div class="fld">
      <label>Product Photography <span class="req">*</span></label>
      <div class="hint" style="margin-bottom:10px">Clean studio shots of every machine — without these the catalog can't ship</div>
      <div class="opt-cards">
        <label class="opt-card"><input type="radio" name="photography" value="all_ready" required><span class="dot"></span><div class="ct"><div class="h">All ready</div><div class="d">Studio shots for every product available</div></div></label>
        <label class="opt-card"><input type="radio" name="photography" value="partial"><span class="dot"></span><div class="ct"><div class="h">Some ready</div><div class="d">Top sellers done, long tail missing</div></div></label>
        <label class="opt-card"><input type="radio" name="photography" value="need_shoot"><span class="dot"></span><div class="ct"><div class="h">Need shoot</div><div class="d">Need professional photography arranged</div></div></label>
        <label class="opt-card"><input type="radio" name="photography" value="use_supplier"><span class="dot"></span><div class="ct"><div class="h">Supplier photos</div><div class="d">Use manufacturer (DHZ etc.) photos for now</div></div></label>
      </div>
      <div class="err-msg">Pick one</div>
    </div>

    <div class="fld">
      <label>Existing Brochure / Catalog PDF</label>
      <div class="opt-group">
        <label class="opt"><input type="radio" name="brochure" value="yes_share"><span class="dot"></span>Yes — will share</label>
        <label class="opt"><input type="radio" name="brochure" value="needs_redesign"><span class="dot"></span>Yes — needs redesign</label>
        <label class="opt"><input type="radio" name="brochure" value="no"><span class="dot"></span>None yet</label>
      </div>
      <div class="hint">If "needs redesign" — Motiontape can quote separately (₹15–25K for a clean 24-page catalog)</div>
    </div>
...
<section id="access" class="page" aria-labelledby="access-title">
  ...
  <h2 class="sec-title" id="access-title">Domain, hosting, email, social — who controls what.</h2>
  ...
  <div class="form-section">
    ...
    <div class="fld">
      <label>Webmail Addresses — confirm or edit <span class="req">*</span></label>
      <div class="hint" style="margin-bottom:10px">Three Google Workspace accounts included. These get set up at launch.</div>
      <div class="fld-row">
        <div class="fld">
          <label for="email_1" style="font-size:10px;color:var(--muted)">Address 1</label>
          <input type="text" id="email_1" name="email_1" required value="info@bzfitness.com">
        </div>
        <div class="fld">
          <label for="email_2" style="font-size:10px;color:var(--muted)">Address 2</label>
          <input type="text" id="email_2" name="email_2" required value="sales@bzfitness.com">
        </div>
      </div>
      <div class="fld">
        <label for="email_3" style="font-size:10px;color:var(--muted)">Address 3</label>
        <input type="text" id="email_3" name="email_3" required value="support@bzfitness.com">
      </div>
      <div class="err-msg">All three required</div>
    </div>

    <div class="fld">
      <label>Active Social Media Accounts</label>
      <div class="hint" style="margin-bottom:10px">Tick whichever apply — links go in the new site footer</div>
      <div class="opt-group">
        <label class="opt"><input type="checkbox" name="social" value="instagram"><span class="dot"></span>Instagram</label>
        <label class="opt"><input type="checkbox" name="social" value="facebook"><span class="dot"></span>Facebook</label>
        <label class="opt"><input type="checkbox" name="social" value="linkedin"><span class="dot"></span>LinkedIn</label>
        <label class="opt"><input type="checkbox" name="social" value="youtube"><span class="dot"></span>YouTube</label>
        <label class="opt"><input type="checkbox" name="social" value="tiktok"><span class="dot"></span>TikTok</label>
        <label class="opt"><input type="checkbox" name="social" value="x"><span class="dot"></span>X (Twitter)</label>
        <label class="opt"><input type="checkbox" name="social" value="snapchat"><span class="dot"></span>Snapchat</label>
      </div>
    </div>
...
<section id="comms" class="page" aria-labelledby="comms-title">
  ...
  <p class="sec-sub">Project rhythm. Cadence and channel. Holidays we should know about.</p>
...
<section id="submit" class="page" aria-labelledby="submit-title">
  ...
  <div class="submit-box">
    <h3>Submit &amp; start the BZ Fitness project</h3>
...
<title>Project Onboarding · BZ Fitness</title>
<meta name="description" content="Project Onboarding for BZ Fitness — Adaline The Agency.">
...
<nav class="topnav" aria-label="Primary">
  <div class="ntag">
    <span class="ntag-main">BZ Fitness</span>
    <span class="sep">/</span>
...
OUT = pathlib.Path(__file__).parent.parent / 'bz-fitness' / 'index.html'
